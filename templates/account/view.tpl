		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			{elseif $column=="t_screen_name"}
				<td data-column="{$column}">
					...
					<button type="button" class="peek" onclick="genericAjaxPopup('peek','c=config&a=handleSectionAction&section=twitter&action=showPeekPopup&id={$result.t_id}&view_id={$view->id}',null,false,'50%');"><span class="glyphicons glyphicons-new-window-alt"></span></button> 
				</td>
